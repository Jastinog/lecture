...
urlpatterns = [
    ...
    path(
        "topic/<int:topic_id>/lecture/<int:lecture_id>/",
        views.topic_player,
        name="topic_player_with_lecture",
    ),
    path(
        "topic/<int:topic_id>/lecture/<int:lecture_id>/<int:start_time>/",
        views.topic_player,
        name="topic_player_with_time",
    ),
    # Section pages
